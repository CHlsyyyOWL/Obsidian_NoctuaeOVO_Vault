...
cd ~/Obisidian/NoctuaeOvO
git init
git remote add origin https://CHlsyyyOWL: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@github.com/CHlsyyyOWL/Obsidian_NoctuaeOVO_Vault.git
git add .
git commit -m "init"
